...
- **Script path includes category prefix:** The maps skill installs under `productivity/`, so the script is at `~/.hermes/skills/productivity/maps/scripts/maps_client.py`. If you get "No such file or directory," check you're including the `productivity/` prefix.
